...
class ModelKlaimAsessorSementara extends Model
{
    protected $table      = 'mk_klaim_asessor_sementara';
    ...
    public function simpanklaimAsessor($formdata, $ta_akademik)
    {
        ...
        $BuilderMkKlaim = $db->table("mk_klaim_asessor_sementara");
            ...
            if ($cekvalidprodi != null) {
                ...
                if ($cekmk != null) {
                    ...
                    if ($nilai != "") {
                        ...
                        if ($tanggapan == 1) {
                            $idklaimbutuh_tanggapan[] = $idklaim;
                            $BuilderMkDetail->set('statusklaim', 3)->where('idklaim', $idklaim)->update();
                        }
                    }
                }
    ...
    {
        $modelKlaimAsessos = new ModelKlaimAsessorSementara();
    ...
    public function CekMatakuliahAsessor($idklaim)
    {
        ...
        $result = $db->query("select * from mk_klaim_asessor_sementara where idklaim='$idklaim'")->getResult();
        return $result;
    }
    ...
    public function getDataKlaimAsessor($noregis)
    {
        $db      = \Config\Database::connect();
        // $BuilderMkKlaim = $db->table("mk_klaim_asessor");
        $result = $db->query("select * from mk_klaim_asessor_sementara where no_peserta='$noregis'")->getResult();
        return $result;
    }
