...
class ModelKlaimDekan extends Model
{
    ...
    public function getDatatoPrint($noregis)
    {
        ...
        $result = $db->query("SELECT
                                ...
                                LEFT JOIN bio_peserta ON bio_peserta.no_peserta = mk_klaim_asessor.no_peserta 
                                where mid(mk_klaim_dekan.idklaim,6,10)='$noregis' and mk_klaim_prodi.idklaim is not null  and mk_klaim_asessor.idklaim is not null and mk_klaim_asessor.nilai != 'E' and mk_klaim_dekan.idklaim is not null
                                ")->getResult();
        return $result;
    }
