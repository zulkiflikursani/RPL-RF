            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Lembar Kerja Assesment Mahasiswa A1</h4>
                                                            ...
                                                            foreach ($dataKlaimMhs as $row) {
                                                                if ($no_peserta != $row->no_peserta) {
                                                                    ...
                                                                    echo "<tr noregis='$row->no_peserta'                    idklaim='$row->idklaim'
                                                                        ...
                                                                        sks='$row->sks'
                                                                        nilai='$row->nilai'>
                                                                        <td rowspan='$row->entry_count_mahasiswa'>$no</td>
                                                                        <td rowspan='$row->entry_count_mahasiswa'>$row->no_peserta</td>
                                                                        <td rowspan='$row->entry_count_mahasiswa'>$row->nama</td>
                                                                        <td>$row->kode_matakuliah</td>
                                                                        <td>$row->nama_matakuliah</td>
                                                                        <td >$row->sks</td>
                                                                        <td>$row->nilai</td>
                                                                        <td>$row->nama_matakuliah_asal</td><td>$row->jumlah_sks</td>
                                                                        <td>$row->nilai_asal</td></tr>";
                                                                    ...
                                                                    echo "<tr noregis='$row->no_peserta'                idklaim='$row->idklaim'
                                                                        ...
                                                                        kdprodi='$row->kode_prodi'
                                                                        nilai='$row->nilai'>
                                                                        <td r>$row->kode_matakuliah</td>
                                                                        <td>$row->nama_matakuliah</td>
                                                                        <td >$row->sks</td><td >$row->nilai</td><td>$row->nama_matakuliah_asal</td><td>$row->jumlah_sks</td><td>$row->nilai_asal</td>
                                                                        </tr>";
                                                                }
                                                            }
                                                        }
