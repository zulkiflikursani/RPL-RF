                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Data Mahasiswa Lulus RPL</h4>
                                    <div class="row">
                                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Data Mahasiswa Belum Melakukan Pembayaran</h4>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <table class="table table2 table-bordered "
                                                title='DATA MAHASISWA BELUM MELAKUKAN PEMBAYARAN'>
                                                <thead class="table-light">
                                                    <tr>
                                                        <th>No</th>
                                                        <th>No Registrasi</th>
                                                ...
                                                <tbody id='bodytable'>
                                                    <?php
                                                    // print_r($dataPesertaAsessor);
                                                    if ($dataLulusBelumBayar) {
                                                        $i = 0;
                                                        foreach ($dataLulusBelumBayar as $row) {
                                                            $i++;
                                                            echo "<tr>
                                                                    <td>$i</td>
                                                                    <td for='noregis'>$row->no_peserta</td>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Data Mahasiswa Sudah Melakukan Pembayaran</h4>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <table class="table table3  table-bordered "
                                                title='DATA MAHASISWA SUDAH MELAKUKAN PEMBAYARAN'>
                                                <thead class="table-light">
                                                    <tr>
                                                        <th>No</th>
                                                        <th>No Registrasi</th>
                                                ...
                                                <tbody id='bodytable'>
                                                    <?php
                                                    // print_r($dataPesertaAsessor);
                                                    if ($dataLulusSudahBayar) {
                                                        $i = 0;
                                                        foreach ($dataLulusSudahBayar as $row) {
                                                            $i++;
