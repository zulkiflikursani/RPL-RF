                                            ...
                                            <div class="modal-body">
                                                <div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="mb-12">
                                                                <label for="formrow-nama-input" class="form-label">
                                                                    <div>
                                                                        <label for="">Pastikan nilai yang telah
                                                                            disingkron oleh Biro Akademik telah dihapus
                                                                            di SISKA !"</label></br>
                                                                    </div>
                                                                    Yakin
                                                                    akan membatalkan validasi pembayaran ?
                                                                </label>
