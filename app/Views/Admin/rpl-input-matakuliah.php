                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <input type="text" class="form-control" id="kdmk" placeholder="Masukkan Kode Matakuliah" value="" required>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="nmmk" placeholder="Masukkan Nama Matakuliah" value="" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="sks" placeholder="Masukkan Jumlah SKS" value="" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="idkur" placeholder="Masukkan Id Kurikulum" value="" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="POST" action="" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        <label for="formrow-email-input" class="form-label">Konsentrasi</label>
                                                                        <select class="form-control " id='ekdkons'>
                                    ...
                                    <h3 class="text-center">PRODI <span id='jprodi'><?= strtoupper($nama_prodi) ?></span></h3>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <button class="btn btn-primary" data-bs-toggle="modal" id='bt-tambah-matakuliah' data-bs-target='.tambah-matakuliah-modal'>Tambah Matakuliah</button>
