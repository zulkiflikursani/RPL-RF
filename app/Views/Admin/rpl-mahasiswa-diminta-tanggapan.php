                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Data Mahasiswa Diminta Tanggapan</h4>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody id='bodytable'>
                                                    <?php
                                                    // print_r($dataMahasisawaDimintaTanggapan);
                                                    if ($dataMahasisawaDimintaTanggapan) {
                                                        $i = 0;
                                                        foreach ($dataMahasisawaDimintaTanggapan as $row) {
                                                            $i++;
                                                            if ($row->jenis_rpl == 1) {
