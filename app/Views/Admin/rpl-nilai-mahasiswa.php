                                    ...
                                    <form method="POST" action="<?= base_url("Admin/setBiodata") ?>">
                                        ...
                                        <div class="row ">
                                            <label for="formrow-inputPendidikan" class="form-label">KTP atau Kartu
                                                Keluarga</label>
                                            <div class="col-md-2">
                                                <a class="button btn btn-primary btn-sm " target="_blank" href='<?= base_url() . "/uploads/berkas/$noregis/ii$noregis.pdf" ?>'>
                                                    Lihat Identitas</a>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <a target="_blank" href='<?= base_url() . "/uploads/berkas/$noregis/i$noregis.pdf" ?>' class="button btn btn-primary btn-sm "> Lihat Ijazah</a>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <a target="_blank" href='<?= base_url() . "/uploads/berkas/$noregis/bb$noregis.pdf" ?>' class="button btn btn-primary btn-sm "> Lihat Bukti Pembayaran</a>
                                            </div>
                                        </div>
