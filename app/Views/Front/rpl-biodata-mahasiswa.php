        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="modal fade modal-edit-bukti-bayar" tabindex="-1" role="dialog" aria-labelledby="mytambah-modal" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content" id='modal-content'>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="post" action="/updatebuktibayarmhs" enctype="multipart/form-data">
                                                <div class="row mb-3">
                            ...
                            <div class="modal fade modal-edit-ijazah" tabindex="-1" role="dialog" aria-labelledby="mytambah-modal" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content" id='modal-content'>
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="post" action="/updateijazahmhs" enctype="multipart/form-data">
                                                <div class="row mb-3">
                                                    <label class="form-check-label" for="formRadios1">
                                                        Upload Ijazah
                                                    </label>
                                                    <input type="hidden" name='noregis' value='<?= $noregis ?>'>
                                                    <div class="input-group mt-3" id='input-buktibayar'>
                                                        <input type="file" class="form-control" name='ijazah' id="inputGroupFile" aria-describedby="inputGroupFileAddon" accept="application/pdf" aria-label="ijazah" required>
                                                    </div>
                                                    <span class="text-danger">Note: File PDF dengan ukuran maksimal 1
                                                        Mb</span>
                                                </div>
                            ...
                            <div class="modal fade modal-edit-identitas" tabindex="-1" role="dialog" aria-labelledby="mytambah-modal" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content" id='modal-content'>
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="post" action="/updateidentitasmhs" enctype="multipart/form-data">
                                                <div class="row mb-3">
                                                    <label class="form-check-label" for="formRadios1">
                                                        Upload Identitas
                                                    </label>
                                                    <input type="hidden" name='noregis' value='<?= $noregis ?>'>
                                                    <div class="input-group mt-3" id='input-buktibayar'>
                                                        <input type="file" class="form-control" name='identitas' id="inputGroupFile" aria-describedby="inputGroupFileAddon" accept="application/pdf" aria-label="identitas" required>
                                                    </div>
                                                    <span class="text-danger">Note: File PDF dengan ukuran maksimal 1
                                                        Mb</span>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="formrow-nama-input" class="form-label">No
                                                        Registrasi</label>
                                                    <input type="text" class="form-control" id="formrow-firstname-input" name="no_peserta" placeholder="Masukkan Nama" value="<?= (isset($datasubmit["no_peserta"]) ? $datasubmit["no_peserta"] : '') ?>" required readonly>
                                                </div>

                                                <div class="mb-3">
                                                    <label for="formrow-nama-input" class="form-label">Nama</label>
                                                    <input type="text" class="form-control" id="formrow-firstname-input" name="nama" placeholder="Masukkan Nama" value="<?= (isset($datasubmit["nama"]) ? $datasubmit["nama"] : '') ?>" required readonly>
                                                </div>


                                                <div class="mb-3">
                                                    <label for="formrow-email-input" class="form-label">Email</label>
                                                    <input type="email" class="form-control" id="formrow-email-input" name="email" placeholder="Masukkan Email ID" value="<?= (isset($datasubmit["email"]) ? $datasubmit["email"] : '') ?>" required readonly>
                                                </div>
                                            ...
                                            <div class="col-lg-7">
                                                <div class="mb-3">
                                                    ...
                                                    <!-- <input type="text" class="form-control" id="formrow-inputProvinsi"
                                                        ...
                                                        required> -->
                                                    <select name="provinsi" id="provinsi" class="form-select select2" onchange="getkab()" required>
                                            ...
                                            <div class="col-lg-7">
                                                <div class="mb-3">
                                                    <label for="formrow-inputKab" class="form-label">Tempat
                                                        Lahir</label>
                                                    <input type="text" class="form-control" id="formrow-inputAlamat" name="tlahir" placeholder="Masukkan Tempat Lahir" value="<?= (isset($datasubmit["t_lahir"]) ? $datasubmit["t_lahir"] : '') ?>" required>
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="formrow-inputInstansi" class="form-label">Tanggal
                                                        Lahir</label>
                                                    <input type="date" class="form-control" id="formrow-inputInstansi" name="ttl" placeholder="Masukkan Tanggal lahir" value="<?= (isset($datasubmit["ttl"]) ? $datasubmit["ttl"] : '') ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="formrow-inputInstansi" class="form-label">Nama Ibu
                                                        Kandung</label>
                                                    <input type="text" class="form-control" id="formrow-inputInstansi" name="ibukandung" placeholder="Masukkan Nama Ibu Kandung" value="<?= (isset($datasubmit["ibu_kandung"]) ? $datasubmit["ibu_kandung"] : '') ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                    <div class="">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="formrow-inputInstansi" name="nik" placeholder="Masukkan Nomor Induk Keluarga (NIK)" value="<?= (isset($datasubmit["nik"]) ? $datasubmit["nik"] : '') ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="autoSizingSelect" name='pendidikan'>
                                                            ...
                                                            <option value="1" <?= (isset($datasubmit["didikakhir"]) && $datasubmit["didikakhir"] == "1" ? 'selected="selected"' : '') ?>>
                                                                SD</option>
                                                            <option value="2" <?= (isset($datasubmit["didikakhir"]) && $datasubmit["didikakhir"] == "2" ? 'selected="selected"' : '') ?>>
                                                                SLTP</option>
                                                            <option value="3" <?= (isset($datasubmit["didikakhir"]) && $datasubmit["didikakhir"] == "3" ? 'selected="selected"' : '') ?>>
                                                                SLTA</option>
                                                            <option value="4" <?= (isset($datasubmit["didikakhir"]) && $datasubmit["didikakhir"] == "4" ? 'selected="selected"' : '') ?>>
                                                                D3</option>
                                                            <option value="5" <?= (isset($datasubmit["didikakhir"]) && $datasubmit["didikakhir"] == "5" ? 'selected="selected"' : '') ?>>
                                                                S1</option>
                                                            <option value="6" <?= (isset($datasubmit["didikakhir"]) && $datasubmit["didikakhir"] == "6" ? 'selected="selected"' : '') ?>>
                                                                D1</option>
                                                            <option value="7" <?= (isset($datasubmit["didikakhir"]) && $datasubmit["didikakhir"] == "7" ? 'selected="selected"' : '') ?>>
                                                                D2</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="formrow-inputPendidikan" class="form-label">Jenis
                                                        RPL</label>
                                                    <select class="form-select" id="jenis_rpl" name='jenis_rpl' onchange="findprodi($(this))">
                                                        <option value=''>
                                                            Pilih...</option>
                                                        <option value="1" <?= (isset($datasubmit["jenis_rpl"]) && $datasubmit["jenis_rpl"] == "1" ? 'selected="selected"' : '') ?>>
                                                            A1</option>
                                                        <option value="2" <?= (isset($datasubmit["jenis_rpl"]) && $datasubmit["jenis_rpl"] == "2" ? 'selected="selected"' : '') ?>>
                                                            A2</option>
                                                        <option value="3" <?= (isset($datasubmit["jenis_rpl"]) && $datasubmit["jenis_rpl"] == "3" ? 'selected="selected"' : '') ?>>
                                                            A3</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="formrow-inputPendidikan" class="form-label">Program
                                                        Studi Pilihan</label>
                                                    <select class="form-select" id="kode_prodi" name='prodi' onchange="findkonsentrasi()">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="konsentrasi" name='konsentrasi' required>
