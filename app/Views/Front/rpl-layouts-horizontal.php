                                    ...
                                    <form method="POST" action="<?= base_url("Front/Registrasi") ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="mb-3">
                                                    <label for="formrow-inputKab" class="form-label">Tempat
                                                        Lahir</label>
                                                    <input type="text" class="form-control" id="formrow-inputAlamat" name="tlahir" placeholder="Masukkan Tempat Lahir" value="<?= (isset($datasubmit["tlahir"]) ? $datasubmit["tlahir"] : '') ?>" required>
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="formrow-inputInstansi" class="form-label">Nama Ibu
                                                        Kandung</label>
                                                    <input type="text" class="form-control" id="formrow-inputInstansi" name="ibukandung" placeholder="Masukkan Nama Ibu Kandung" value="<?= (isset($datasubmit["ibukandung"]) ? $datasubmit["ibukandung"] : '') ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="autoSizingSelect" name='pendidikan'>
                                                            ...
                                                            <option value="1" <?php (isset($datasubmit["pendidikan"]) && $datasubmit["pendidikan"] == "1" ? 'selected="selected"' : '') ?>>
                                                                SD</option>
                                                            <option value="2" <?php (isset($datasubmit["pendidikan"]) && $datasubmit["pendidikan"] == "2" ? 'selected="selected"' : '') ?>>
                                                                SLTP</option>
                                                            <option value="3" <?php (isset($datasubmit["pendidikan"]) && $datasubmit["pendidikan"] == "3" ? 'selected="selected"' : '') ?>>
                                                                SLTA</option>
                                                            <option value="4" <?php (isset($datasubmit["pendidikan"]) && $datasubmit["pendidikan"] == "6" ? 'selected="selected"' : '') ?>>
                                                                D1</option>
                                                            <option value="5" <?php (isset($datasubmit["pendidikan"]) && $datasubmit["pendidikan"] == "7" ? 'selected="selected"' : '') ?>>
                                                                D2</option>
                                                            <option value="4" <?php (isset($datasubmit["pendidikan"]) && $datasubmit["pendidikan"] == "4" ? 'selected="selected"' : '') ?>>
                                                                D3</option>
                                                            <option value="5" <?php (isset($datasubmit["pendidikan"]) && $datasubmit["pendidikan"] == "5" ? 'selected="selected"' : '') ?>>
                                                                S1</option>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="input-group mt-3" id='input-buktibayar'>
                                                <input type="file" class="form-control" name='identitas' id="inputGroupFile" aria-describedby="inputGroupFileAddon" accept="application/pdf" aria-label="buktiBayar" required>
                                            </div>
    ...
    <script>
        ...
        function setkab(data) {
            $.each(data, function(index, row) {
                $('#kab').append("<option>" + row['nama_wilayah'] + "</option>")
            })
            $('#loading').hide();
