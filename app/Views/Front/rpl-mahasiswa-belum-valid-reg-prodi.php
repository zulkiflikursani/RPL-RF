                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class='col-md-12'>
                                            ...
                                            <div class="mb-3">
                                                <h4 class='text-center mb-4'>Silahkan Konfirmasi ke Staf Prodi
                                                    <?= $prodi ?>
                                                </h4>
                                                <p class='text-center mb-5'>Noted: Jika belum melakukan konsultasi
                                                    dengan prodi tujuan RPL, Silahkan melakukan konsultasi terlebih
                                                    dahulu untuk dilakukan validasi</p>
                                                <?php
                                                if (isset($dataPIC)) {
                                                    foreach ($dataPIC as $row) {
                                                ?>
                                                        <h3 class='text-center mb-5'><?= $row['nmpengguna'] ?>
                                                            <h3 class='text-center mb-5'>Nomor Konfirmasi WA :
                                                                <a href="https://wa.me/<?= $row['nohp'] ?>" target="_blank"><?= $row['nohp'] ?></a>
                                                            </h3>
                                                    <?php
                                                    }
                                                }
                                                    ?>
                                                    <h3 class='text-center mb-2'>Prodi <?= $prodi ?> Universitas Fajar
                                                    </h3>
