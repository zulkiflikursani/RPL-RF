                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- modal hapus semua matakuliah -->
                                    <div class="modal fade modal-hapus-matakuliah" tabindex="-1" role="dialog"
                                        aria-labelledby="mytambah-modal" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                <form method="POST" action="<?= base_url("delallklaimmka1") ?>">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- content -->
                                                        <h5 class="modal-title" id="myLargeModalLabel">Proses ini akan
                                                            menghapus semua data klaim matakuliah yang ada sebelumnya,
                                                            Yakin
                                                            untuk lanjut ?
                                                        </h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" id='btya' iddokumen=''
                                                            class="btn btn-primary w-md">Ya</button>
                                                        <button type="button" class="btn btn-primary w-md"
                                                            data-bs-dismiss="modal" aria-label="Close">Tidak</button>
                                    ...
                                    <div class="modal fade tambah-matakuliah-modal" tabindex="-1" role="dialog"
                                        aria-labelledby="mytambah-matakuliah-modal" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content col-12">
                                                ...
                                                <div class="modal-body">
                                                    <!-- content -->
                                                    <form method="POST"
                                                        action="<?= base_url("Front/SimpanMatakuliahA1") ?>">
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-5">
                                                                ...
                                                                <input type="text" class="form-control col-2"
                                                                    id="formrow-inputProvinsi" name="kode_matakuliah"
                                                                    placeholder="Masukkan Kode Matakuliah" value="">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="formrow-inputProvinsi"
                                                                    ...
                                                                    Matakuliah</label>
                                                                <input type="text" class="form-control"
                                                                    id="formrow-inputProvinsi" name="nama_matakuliah"
                                                                    placeholder="Masukkan Nama Matakuliah" value="">
                                                            </div>
                                                            <div class="mb-3 col-md-2">
                                                                ...
                                                                <input type="text" class="form-control col-md-3"
                                                                    id="formrow-inputProvinsi" name="sks"
                                                            ...
                                                            <div class="row">
                                                                <div class="mb-3 col-md-2">
                                                                    ...
                                                                    <select class='form-select col-md-3' name="Nilai"
                                                                        id="Nilai">
                                    ...
                                    <!-- endmodal -->
                                    <div class="modal fade confirm-deletemk-modal" tabindex="-1" role="dialog"
                                        aria-labelledby="mytambah-matakuliah-modal" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content col-12">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <!-- content -->
                                                    <form method="POST"
                                                        action="<?= base_url("Front/HapusMatakuliahA1") ?>">
                                                        <div class="row">
                                    ...
                                    <div class="modal fade submit-matakuliah-modal" tabindex="-1" role="dialog"
                                        aria-labelledby="mytambah-matakuliah-modal" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content col-12">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <!-- content -->
                                                    <form method="POST"
                                                        action="<?= base_url("Front/SubmitMatakuliahA1") ?>">
                                                        <div class="row">
                                                        ...
                                                        <input type="hidden" id='enoregis' name='noregis'
                                                            value='<?= $noregis ?>' readonly>
                                                        <div>
                                                            <button type="submit"
                                                                class="btn btn-primary w-md">Ya</button>
                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div for="" class='col-md-4'>
                                                    ...
                                                    ?>
                                                    <input type="hidden" id='ptasal' class="form-control" name='ptasal'
                                                        value='<?= $kdptasal ?>' readonly />
                                                    <input type="text" id='ptasal' class="form-control" name='nmptasal'
                                                        value='<?= $nmptasal ?>' readonly />
                                                    <?php
                                    ...
                                    <button type="button" class="btn btn-primary" id='tambah-matakuliah'
                                        data-bs-toggle="modal" data-bs-target=".tambah-matakuliah-modal">Tambah
                                        Matakuliah</button>
                                    <a href="<?= base_url("importmka1") ?>"><button type="button"
                                            class="btn btn-primary ">Import Matakuliah</button></a>
                                    ...
                                    <div>
                                        ...
                                        <button type="button" data-bs-toggle="modal"
                                            data-bs-target=".submit-matakuliah-modal"
                                            class="btn btn-primary mt-2">Submit</button>
                                        <button type="button" data-bs-toggle="modal"
                                            data-bs-target=".modal-hapus-matakuliah" class="btn btn-primary mt-2">Hapus
                                            Matakuliah</button>
                                    </div>
                                </div>
                            </div>
