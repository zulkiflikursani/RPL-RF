                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <h5 class="font-size-14 mt-0" key="t-applications"><?= lang('Files.Applications') ?>
                                    </h5>
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);"
                                                key="t-ecommerce"><?= lang('Files.Ecommerce') ?></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"
                                                key="t-calendar"><?= lang('Files.Calendars') ?></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="javascript:void(0);"
                                                key="t-projects"><?= lang('Files.Projects') ?></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="javascript:void(0);"
                                                key="t-contacts"><?= lang('Files.Contacts') ?></a>
                                        </li>
                                    </ul>
                                </div>

                                <div class="col-md-4">
                                    <h5 class="font-size-14 mt-0" key="t-extra-pages"><?= lang('Files.Extra Pages') ?>
                                    </h5>
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);"
                                        ...
                                        <li>
                                            <a href="javascript:void(0);"
                                                key="t-horizontal"><?= lang('Files.Horizontal Layout') ?></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"
