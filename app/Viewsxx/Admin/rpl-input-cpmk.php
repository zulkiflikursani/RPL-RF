                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="mb-1">
                                                    ...
                                                    <select name="fakultas" id="fakultas" onchange="getprodi()"
                                                        class="form-select">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="formrow-inputPendidikan" class="form-label">Program
                                                        Studi</label>
                                                    <select class="form-select" id="prodi" onchange='getMatakuliah()'
                                                        name='prodi' required>
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="POST"
                                                            action="<?= base_url("Admin/SimpanPengguna") ?>"
