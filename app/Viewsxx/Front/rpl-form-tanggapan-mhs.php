                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        if (isset($klaimAsessor)) {
                                            foreach ($klaimAsessor as $d) {
                                                $tanggapanAsessor = $d['ket_tanggapan'];
                                            }
                                        }
                                        ?>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <form action="">
                                                            ...
                                                            <div class="mb-3 col-md-12">
                                                                <label for="formrow-nama-input"
                                                                    class="form-label">Keterangan Tanggapan
                                                                    Asessor</label>
                                                                <textarea class="form-control" id="desk"
                                                                    name="deskripsi" placeholder="Deskripsi"
                                                                    readonly><?= (isset($tanggapanAsessor) ? $tanggapanAsessor : '') ?></textarea>
...
$(document).ready(function() {
    ...
    <?php
        ...
        if (isset($dataKlaimMhs[0]['statusklaim'])) {
            ...
            if ($dataKlaimMhs[0]['statusklaim'] == 2 || $dataKlaimMhs[0]['statusklaim'] == 3) {
            ?>
    $('.select-cpmk').attr("disabled", true);
    <?php
            }
        }
...
function inputnilai($idcpmk, $nilai = "")
{
    if ($nilai != "") {
        if ($nilai == "B") {
            ...
            <select class='form-select select-cpmk' required>
